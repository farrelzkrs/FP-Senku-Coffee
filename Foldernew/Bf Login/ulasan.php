            ...
            <div class="swiper-wrapper">
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        $foto_profil = !empty($row['foto_profil']) ? '../uploads/' . htmlspecialchars($row['foto_profil']) : 'https://ui-avatars.com/api/?name=' . urlencode($username) . '&background=deb887&color=fff';
