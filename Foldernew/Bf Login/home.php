    ...
    <section id="home">
        <div class="content">
            <div class="postwelcome">
                <div id="carouselPosterWelcome" class="carousel slide" data-bs-ride="carousel" style="margin: 0px 60px 0px 60px;">
                    ...
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item<?= $i==0 ? ' active' : '' ?>">
                            <img src="../uploads/<?= htmlspecialchars($row['url_post']) ?>" class="d-block w-100" alt="<?= htmlspecialchars($row['judul_post']) ?>">
                    ...
                    <button class="carousel-control-prev" type="button" data-bs-target="#carouselPosterWelcome" data-bs-slide="prev">
                        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                        <span class="visually-hidden">Previous</span>
                    </button>
                    <button class="carousel-control-next" type="button" data-bs-target="#carouselPosterWelcome" data-bs-slide="next">
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-4">
                    <div class="card h-100">
                        <img src="../uploads/<?= htmlspecialchars($row['gambar_url']) ?>" class="card-img-top menu-item" alt="<?= htmlspecialchars($row['nama_produk']) ?>">
                        <div class="card-body d-flex flex-column">
                            <h5 class="card-title"><?= htmlspecialchars($row['nama_produk']) ?></h5>
                            <p class="card-text"><?= htmlspecialchars($row['deskripsi']) ?></p>
                            <p class="card-text mt-auto"><strong>Rp <?= number_format($row['harga'],0,',','.') ?></strong></p>
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6" style="text-align: justify;">
                    ...
                    <a href="informasi.php" class="btn btn-outline-success mt-3 px-4" style="width: 170px;">Selengkapnya</a>
                </div>
            </div>
        </div>
    </section>
