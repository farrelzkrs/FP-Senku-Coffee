            ...
            <table class="table table-bordered table-striped align-middle">
                ...
                <?php $no = 1; while($row = $result->fetch_assoc()): ?>
                    <tr>
                        ...
                        <td>
                            <a href="../Af Login/changepass2.php?id=<?= $row['id_users'] ?>" class="btn btn-warning btn-sm">
                    ...
                    <div class="modal-content">
                        <form method="post" action="" autocomplete="off">
                            ...
                            <div class="modal-body text-center">
                                <input type="hidden" name="id_users" id="hapus-id-users">
                                <input type="hidden" name="username_pengunjung" id="hapus-username-hidden">
                                <p>Anda yakin ingin menghapus akun <b id="hapus-username"></b>?</p>
                                <div class="mb-3">
                            ...
                            <div class="modal-footer justify-content-center">
                                ...
                                <button type="submit" class="btn btn-danger">Setuju & Hapus</button>
                            </div>
                        </form>
                    </div>
                </div>
