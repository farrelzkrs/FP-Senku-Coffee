...
// Ambil foto profil
$foto_profil = $foto ? '../uploads/'.$foto : '../Resource/fotoprofil2.jpg';
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <div class="profil-main">
        <div class="profil-header">
            <img src="<?= htmlspecialchars($foto_profil) ?>" alt="Foto Profil" class="profil-img">
            <div>
...
<?php endif; ?>
        ...
        <div class="profil-section">
            ...
            <button type="button" class="btn btn-outline-danger mt-2" data-bs-toggle="modal" data-bs-target="#verifDeleteModal">
        Hapus Akun
    </button>
        </div>
    </div>
