        ...
        <div class="container-fluid" style="margin: 0px 50px 0px 50px; padding: 10px;">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto me-2 mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link<?= $current == 'notifpesan.php' ? ' active' : '' ?>" href="notifpesan.php">Pesan</a>
                    </li>
                </ul>
                <ul class="navbar-nav ms-2">
                    <li class="nav-profil-item dropdown dropdown-profil">
                        <a class="nav-link dropdown-toggle d-flex align-items-center" href="#"
                            id="navbarProfileDropdown" role="button" data-bs-toggle="dropdown"
                            aria-expanded="false">
                            <img src="<?= htmlspecialchars($foto_profil) . '?v=' . time() ?>" alt="Profil" class="rounded-circle" width="47"
                                height="47" style="object-fit: cover; margin-right: 10px;">
